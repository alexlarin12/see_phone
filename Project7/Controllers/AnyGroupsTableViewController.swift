//
//  ThreeTitleTableViewController.swift
//  Project7
//
...
class AnyGroupsTableViewController: UITableViewController {
    
    var groups: [GroupModel] = [
        GroupModel(nameGroup : "Cars"),
        GroupModel(nameGroup : "Bolids"),
        GroupModel(nameGroup : "Begin English"),
        GroupModel(nameGroup : "Business")
    ]
