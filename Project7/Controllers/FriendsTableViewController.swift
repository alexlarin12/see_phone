//
//  OneTitleTableViewController.swift
//  Project7
//
...
class FriendsTableViewController: UITableViewController {
    ...
    var friends: [UserModel] = [
        UserModel(name: "Alex Larin"),
        UserModel(name: "Ivan Larin"),
        UserModel(name: "Elena Voevodina"),
        UserModel(name: "Masha Larina"),
        UserModel(name: "Nastya Larina")
    ]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "ForecastSegue",
            ...
            forecastController.friendNameForTitle = name
